 ...
 * to s. Otherwise, append the character followed by
 * the group's length. The compressed string s should
 * not be returned separately, but instead, be stored
 ...
 * 
 * Note: The characters in the array beyond the 
 * returned length do not matter and should be ignored.
 * 
 * Example 1:
 * 
 ...
 * 
 * Input: chars = ["a"]
 * Output: Return 1, and the first character of the 
 * input array should be: ["a"]
 * 
